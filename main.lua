...
local au=af("输入密钥","key",nil,"Input",function(au)
am=au
end)
...
local ay=ae("离开","log-out",function()
ak:Close()()
...
local az=ae("确认","arrow-right",function()
